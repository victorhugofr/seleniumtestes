...
public class DadosPessoa {
	...
	public static Pessoa gerarDadosPessoa(boolean isEstrangeiro, boolean possuiCPF) {
        ...
        if (sexo) {
			pessoa.setSexo("F");
			pessoa.setNome("Pessoa F Selenium"  + " " + GerarNumeroRomano.toRoman((int) Math.round(Math.random() * 4000)));
		} else {
			pessoa.setSexo("M");
			pessoa.setNome("Pessoa M Selenium"  + " " + GerarNumeroRomano.toRoman((int) Math.round(Math.random() * 4000)));
		}
		...
		pessoa.setEmail(GerarNumeroRomano.toRoman((int) Math.round(Math.random() * 1000))+"sigsaude@"+
							GerarNumeroRomano.toRoman((int) Math.round(Math.random() * 1000))+".com");
	...
	public static Pessoa gerarDadosPessoaComNomeSocialValido(boolean isEstrangeiro, boolean possuiCPF) {
		...
		pessoa.setNomeSocial("NomeSocial " + dataAtual + " " + GerarNumeroRomano.toRoman((int) Math.round(Math.random() * 4000)));
		return pessoa;
	}
